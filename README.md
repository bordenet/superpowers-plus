...
> **Note:** TypeScript-specific skills (`typescript-project-conventions`, `typescript-strict-mode`, `cognitive-complexity-refactoring`, `vitest-testing-patterns`) have been migrated to [superpowers-example-org](https://[INTERNAL-GITLAB]-org.net/mbordenet/superpowers-example-org) (proprietary).
