...
| Skill | What it does |
|-------|-------------|
| [**code-review-battery**](skills/engineering/code-review-battery/skill.md) | Dispatches 5 specialist reviewers in parallel (Defect Finder, Design Critic, Guardian, Standards Enforcer, Performance Analyst) instead of one shallow pass. Slash command: `/sp-codereview-battery [min-score]` (optional 1.0–10.0 quality threshold, default 7.0). |
