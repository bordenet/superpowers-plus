...
const INTENT_PATTERNS = [
  ...
  { patterns: ['compare approaches', 'comparison matrix', 'evaluate alternatives',
               'decision options with adversarial review', 'generate options compare and red team',
               'debate the options', 'structured decision making', 'design triad'],
  ...
  { patterns: ["what's the best approach", "where should we put", "which option", "how should this be structured",
               ...
               "recommend a strategy", "what would you recommend", "what's the best place"],
