...
const INTENT_PATTERNS = [
  // Human-reported recurrence. Keep this before generic debugging and build
  // intents: recurrence changes the job from repairing one symptom to
  // replacing the control that allowed the same failure through again.
  { patterns: ['happened again', 'keeps happening', 'same mistake again',
               'said this was fixed', 'already fixed this', 'issue returned'],
    skills: ['durable-correction'], boost: BOOST_ELEVATED },
  ...
  { patterns: ['improve the skills', 'self-improve', 'learn from mistakes',
               'skill evolution', 'recurring pattern',
  ...
  // LLM skill review (primary reviewer for skill.md files -- see coordination.escalates_to
  // for the redirect relationship with progressive-harsh-review/code-review-battery)
  { patterns: ['review this skill file', 'skill infrastructure review',
               'review skill tooling', 'llm skill review', 'review agent tooling',
               'harsh review for skills'],
    skills: ['llm-skill-review'], boost: BOOST_HIGH },
