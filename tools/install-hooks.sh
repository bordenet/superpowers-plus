...
echo "  • pre-commit: code-review sentinel, file endings, shell syntax, JSON, IP scan, review token"
echo "  • pre-push: code-review clearance (sentinel SHA match) + proprietary IP scan"
echo ""
echo "Review token gate: Run 'bash tools/commit-gate.sh' before committing."
echo "Code review gate: Run code-review-battery to write .code-review-cleared before pushing."
