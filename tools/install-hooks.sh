...
echo "  1. Run 'bash tools/commit-gate.sh'  — runs lint/test/harsh-review, mints review token"
echo "  2. git commit                        — pre-commit verifies sentinel + consumes token"
echo ""
echo "Push workflow:"
echo "  1. Run code-review-battery          — writes .code-review-cleared with exact HEAD SHA"
