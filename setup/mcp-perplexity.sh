...
#          server for Claude Desktop (macOS), Claude Code CLI, and provides
#          manual configuration instructions for Augment Code.
# USAGE: ./setup/mcp-perplexity.sh
# PLATFORM: macOS, Linux (Claude Code), WSL
# VERSION: 1.0.0
# REQUIRES: PERPLEXITY_API_KEY env var or interactive prompt
