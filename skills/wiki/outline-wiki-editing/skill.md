...
triggers: ["edit wiki page", "update wiki page", "create wiki page", "delete wiki page", "push to outline", "edit wiki", "create wiki document", "wiki.int.[company].net", "outline wiki", "outline page", "outline document", "edit outline", "wiki url", "update wiki", "modify wiki page"]
...
**When you see `wiki.int.[company].net` or any request to read/edit a wiki page:**
...
4. **Extract the document slug** from the URL. Example: `wiki.int.[company].net/doc/my-page-title-KCTRf3aUTr` → slug is `my-page-title-KCTRf3aUTr`.
