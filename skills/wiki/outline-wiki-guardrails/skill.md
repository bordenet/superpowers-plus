...
**WRONG:** `https://wiki.int.[company].net/doc/{urlId}` → 404 (SPA returns 200 but renders "Not Found")
**RIGHT:** `https://wiki.int.[company].net{url}` → works
...
**Base URL:** `https://wiki.int.[company].net/api`
...
`[https://wiki.int.[company].net/doc/X](https://wiki.int.[company].net/doc/X)`
