...
|------|-----------|--------------|
| [Architecture](/doc/cari-scheduler-xyz) | Data flow | 2026-03-06 |
...
✅ Git: 3 files modified (scheduler.ts, index.cfm, cari_config.js)
...
3. `ask_documents_outline(query: "What is the Cari scheduler data flow?")`
