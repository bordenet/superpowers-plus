...
|---------|-------|--------|
| [Product] Reliability & Performance | 23 | DELTA-1175, DELTA-952, ... |
| SMR Launch | 18 | DELTA-1100, ... |

### 🔍 Suggested Mappings (N issues)
| Issue | Title | Suggested Project | Confidence | Reason |
|-------|-------|-------------------|------------|--------|
| DELTA-1175 | Telephony Service Memory Leak | [Product] Reliability | HIGH | Title contains "memory leak" alias |
