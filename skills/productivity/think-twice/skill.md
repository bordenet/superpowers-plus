...
3. **Dispatch** (in priority order):
   - Sub-agent (read-only) — free, instant; always available (Claude Code: `sub-agent-explore`; other platforms: see `using-superpowers`'s Platform Adaptation section for the equivalent dispatch mechanism)
