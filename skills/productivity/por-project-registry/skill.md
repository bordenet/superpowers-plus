...
1. **Aliases** — What other names/abbreviations might engineers use?
   (e.g., "reliability", "perf", "stability" for "Cari Reliability & Performance")
...
projects:
  ...
  - name: "SMR (SellMyRide) Launch"
    aliases: ["SMR", "sellmyride", "acquisition", "outbound"]
    linear:
      labels: ["roadmap", "SMR"]
      initiative: null
      project: "sellmyride"
