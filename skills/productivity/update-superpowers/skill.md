...
> **Override:** Team-specific overlays (e.g., superpowers-[product]) may override this skill with additional repos and install targets. This base version covers the core chain only.
...
This cascades: `obra/superpowers → superpowers-plus → superpowers-[company]`
...
- **Team overlays** (superpowers-[product], superpowers-[product]) override this skill with their own version that includes additional repos and a different install entry point.
