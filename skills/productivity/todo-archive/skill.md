...
|-------|-------|----------|---------------|
| 2026-03 | 42 | #engineering (18) | DELTA-1239, DELTA-1243 |
| 2026-02 | 38 | #recruiting (12) | DELTA-1237 |
```
...
### By Linear issue
```
search archived todos for DELTA-1239
→ grep -rn "DELTA-1239" "$ARCHIVE_DIR"/*.md
```
