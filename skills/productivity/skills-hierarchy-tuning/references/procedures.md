...
2. Update wiki pages:
   - [Superpowers Skills](https://wiki.int.[company].net/doc/superpowers-skills-cASQJAkNFD)
   - [Refactoring (AI-Maintained)](https://wiki.int.[company].net/doc/refactoring-ai-maintained-2nV606J5uY)
