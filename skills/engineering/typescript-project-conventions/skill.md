...
- Setting up a new TypeScript project with consistent conventions
- Reviewing existing TypeScript code for convention compliance
- Onboarding to an existing TypeScript codebase
