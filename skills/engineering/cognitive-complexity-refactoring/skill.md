...
- Reducing cognitive complexity in functions flagged by linters
- Refactoring deeply nested conditionals or long switch statements
- Simplifying control flow in legacy code

## Common Failure Modes

- **Extracting too aggressively:** Creating many tiny functions that obscure the overall flow
- **Losing context:** Refactoring reduces complexity score but makes the code harder to understand
- **Skipping tests:** Refactoring without running the test suite after each change
