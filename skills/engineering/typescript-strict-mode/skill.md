...
- Enabling or tightening TypeScript strict mode flags
- Fixing type errors after enabling strictNullChecks or strictPropertyInitialization
- Auditing a codebase for strict-mode readiness

## Common Failure Modes

- **Type assertion overuse:** Fixing strict errors with 'as any' instead of proper type narrowing
- **Big-bang migration:** Enabling all strict flags at once instead of incrementally
- **Ignoring test files:** Enabling strict in source but leaving tests with loose types

## Failure Modes

| Mode | Symptom | Recovery |
|------|---------|----------|
| Suppress with biome-ignore | Type safety lost | Fix actual type issue instead |
