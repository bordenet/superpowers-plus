...
SMR_STAGING_ALIAS_URL=https://smr.[product]-telephony.com
```
...
# STAGING (alias)
nslookup smr.[product]-telephony.com
```
...
```bash
# Check cert validity
echo | openssl s_client -servername smr.[product]-telephony.com \
  -connect smr.[product]-telephony.com:443 2>/dev/null | \
