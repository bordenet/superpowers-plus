...
<EXTREMELY_IMPORTANT>
These guardrails protect the production Cari system from investigation-related impact. **Violating any guardrail is a blocking error — stop and fix before proceeding.**
