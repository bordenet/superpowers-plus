...
|-------------|-------------|----------------------|
| Production | `telephony-prod` | `/ecs/[product]-telephony-production` |
| Dev | `telephony-dev` | `/ecs/[product]-telephony-dev` |
| Staging | `telephony-dev` | `/ecs/[product]-telephony-staging` |
