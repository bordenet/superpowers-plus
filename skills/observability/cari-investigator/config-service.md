...
| acquisition_configs | account_id -> lskinid | JSONB config blob | AcquisitionPortal acquisition AI config |
...
### 4. Lookup by AcquisitionPortal Store ID
...
WHERE ac.is_active = true
  AND ac.config->>'acquisitionStoreId' = '<storeId>'
...
- acquisition_config->>'active' -- Acquisition (AcquisitionPortal) AI active?
