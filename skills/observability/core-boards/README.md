...
Generate HTML announcements for CallBox's Core Boards system.
...
<div style="font-family: Segoe UI, Arial, sans-serif; font-size: 14px; line-height: 1.6; max-width: 600px;">
  <p style="margin-bottom: 16px;">
    ...
    "<a href="https://wiki.int.callbox.net/doc/..." style="color: #0066cc;">AI & Interview Integrity Policy</a>" 
...
From CallBox's [Modes of Communication](https://wiki.int.callbox.net/doc/modes-of-communication-ko1N62U1wn):
