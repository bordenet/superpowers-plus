...
description: Use when reviewing resumes, screening candidates, evaluating CVs, or when user shares resume text/screenshot. Triggers on "review this resume", "screen this candidate", "evaluate this CV", "is this person qualified", "should we phone screen", "worth interviewing?". For Senior SDE role against [Company] hiring criteria.
...
> **📋 Source:** https://wiki.int.[company].net/doc/llm-prompt-LfFH19Gj0y
