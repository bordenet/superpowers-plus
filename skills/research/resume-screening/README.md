...
A [superpowers skill](../install-augment-superpowers.sh) that evaluates Senior SDE candidates against [Company]'s hiring bar. Outputs HIRE/NO-HIRE/PROBE with targeted phone screen questions.

> **📚 Wiki:** https://wiki.int.[company].net/doc/superpowers-skills-cASQJAkNFD
...
https://wiki.int.[company].net/doc/superpowers-skills-cASQJAkNFD
...
| **Wiki LLM Prompt** | [wiki.int.[company].net](https://wiki.int.[company].net/doc/llm-prompt-LfFH19Gj0y) | **Source of truth** — check daily |
...
- No specific company reference ([Company], automotive, voice AI)
