...
> "A customer calls, books an appointment, then calls back 2 hours later to change it. Design the system that lets Cari remember the first call. Start with the data model, then walk me through retrieval and LLM injection."
...
Reference: [Flex Coverage & Follow-up Probes](https://wiki.int.callbox.net/doc/sr-sde-interview-flex-coverage-and-follow-up-probes-x0yBsXvMH1)
...
Reference: [Candidate Experience & Closing](https://wiki.int.callbox.net/doc/sr-sde-interview-candidate-experience-and-closing-nQui9kY7Dv)
