...
| `code-review-battery` | Dispatches 5 parallel specialist reviewers instead of one shallow pass. Slash command: `/sp-codereview-battery [min-score]` (optional 1.0–10.0 quality threshold, default 7.0). `/sp-deepreview` is a legacy synonym. |
