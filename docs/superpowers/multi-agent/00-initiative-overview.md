...
|---|-----------|--------|--------------|--------|---------------|
| 1 | **Forked Debugging** | `feat/forked-debugging-superpower` | P1 | 🟡 **PROTOTYPED** — all TODOs done, experiments NOT yet run (harness is stub) | [Implementation](../../../skills/engineering/debug-conductor/) · [Experiment Matrix](../../../exercises/forked-debugging/experiment-matrix.md) · [Results](../../../exercises/forked-debugging/results-comparison.md) |
