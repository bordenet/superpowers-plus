...
graph TD
  ...
  progressive_harsh_review -->|then| llm_skill_review
  llm_skill_review -->|enables| think_twice
  llm_skill_review ==>|escalates to| code_review_battery
  llm_skill_review ==>|escalates to| progressive_harsh_review
  ...
  writing_plans -->|then| subagent_driven_development
